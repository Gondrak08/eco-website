...
const ShowCase = () => {
    return (
        <section className="showCase-container flex items-center justify-center  py-8 ">
            <div className="container grid grid-cols-1 md:grid-cols-2 justify-center md:space-x-3 space-y-4">
                <div className="two flex items-center">
                    <div className="texts flex flex-col px-3 items-center space-y-3 md:h-[80%] ">
                        ...
                        self-end
                        w-[fit-content] p-3 text-white font-bold text-[18px]  rounded" >Contribua você também com esta causa !</button>
                    </div>
                </div>
